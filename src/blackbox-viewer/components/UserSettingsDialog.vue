...
// Bundled image maps so Vite emits file URLs (works with base "./" on Android too).
const motorOrderImages = import.meta.glob("../../images/motor_order/*.svg", { eager: true, query: "?url", import: "default" });
const stickModeImages = import.meta.glob("../../images/stick_modes/*.png", { eager: true, query: "?url", import: "default" });
...
const mixerImageUrl = computed(
    () => motorOrderImages[`../../images/motor_order/${mixerImageName.value}.svg`] ?? "",
);
const stickModeImageUrl = computed(
    () => stickModeImages[`../../images/stick_modes/Mode_${local.value.stickMode}.png`] ?? "",
);
