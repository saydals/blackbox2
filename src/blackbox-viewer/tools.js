...
export function firmwareGreaterOrEqual(sysConfig, bf_version, cf_version) {
     ...
     ***/
    // Rotorflight forked from BF 4.3-era code: treat as modern BF for all
    // version-gated display conversions (reference rfblackbox puts ROTORFLIGHT
    // on the modern branch of every such check).
